function [buildings] = func_buildings_read(files_number,folder)
...
for i = 1:length(files_number)
    disp(i)
    out = buildings_read([folder,num2str(files_number(i)),'.txt']);
...
clearvars out_building_id building_id positions
