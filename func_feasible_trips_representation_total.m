function [] = func_feasible_trips_representation_total(community_area,flight,lines,centroids,UAMstops,cond,indx,label,hour,type,map,size_point)
...
p = func_boundaries_plot(community_area,lines,2,centroids,UAMstops,type,map);
hold on
